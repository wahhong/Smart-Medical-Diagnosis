...
public class EditDoctorPassword extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (!isValid) {
            dispatcher = request.getRequestDispatcher("editDoctorPassword.jsp");
        ...
        try {
            ...
            if (isUpdated) {
                session.setAttribute("successMsg", "Doctor has update password successfully.");
            } else {
                session.setAttribute("errorMsg", "Doctor update password unsuccessfully.");
            }

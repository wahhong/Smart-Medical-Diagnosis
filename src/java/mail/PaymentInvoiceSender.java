...
public class PaymentInvoiceSender {

    public static void sendEmail(String recipient, String subject, String paymentID, String serviceName, double servicePrice, String appointmentDate, String appointmentTime, String paymentMethod) {
        ...
        try {
            ...
            String htmlBody = "<!DOCTYPE html>"
                    ...
                    + "</tr>"
                    + "<tr>"
                    + "<td>" + serviceName + " " + appointmentDate + " (" + appointmentTime + ")" + " deposit</td>"
                    + "<td>RM " + String.format("%.2f", servicePrice) + "</td>"
                    + "</tr>"
                    + "<tr>"
                    + "<td colspan='1' style='text-align: right;'><strong>Total:</strong></td>"
                    + "<td><strong>RM " + String.format("%.2f",servicePrice) + "</strong></td>"
                    + "</tr>"
                    + "</table>"

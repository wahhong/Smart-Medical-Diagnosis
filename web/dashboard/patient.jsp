                        ...
                        <div class="table-responsive">
                            <table id="add-row" class="display table table-striped table-hover" >
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="editPatientImage.jsp?id=<%= patient.getPatientID()%>"><img class="avatar-img rounded-circle" src="<%= (patientImage != null && !patientImage.isEmpty()) ? "data:image/jpeg;base64," + patientImage : "img/team-1.jpg"%>" alt="" style="width: 50px; height: 50px;"></a>
                                        </td>
                                        ...
                                        <td><%= patient.getPatientRegisterDate()%></td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="form-button-action">
                                                <a href="editPatient.jsp?id=<%= patient.getPatientID()%>" data-bs-toggle="tooltip" title="Edit" class="btn btn-link btn-primary btn-lg">
                                                    <i class="fa fa-edit"></i>
                                                </a>
                                                <button data-id="<%= patient.getPatientID()%>" data-bs-toggle="tooltip" title="Remove" class="btn btn-link btn-danger delete-btn">
